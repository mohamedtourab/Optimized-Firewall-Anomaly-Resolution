...
- [ConflictResolverTest.java](https://github.com/MohamedMamdouh95/Optimized-Firewall-Anomaly-Resolution/tree/master/src/test/test/ConflictResolverTest.java)
    ...
    - **testExecuteSolveRequest()** Check that executeSolveRequest is working properly and solveRequest is applied correctly and all conflict anomalies are solved.
