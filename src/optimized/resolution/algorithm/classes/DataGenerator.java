...
public class DataGenerator {
    ...
    public static SolveRequest createSolveRequest() {
        ...
        shadowingConflictSolutionType.setAnomalyId(BigInteger.valueOf(16));
        ...
        shadowingConflictSolutionType.setAnomalyId(BigInteger.valueOf(20));
        shadowingConflictSolutionType.setToRemove(false);
        shadowingConflictSolutionType.setToChangeOrder(true);
        solveRequest.getShadowingConflictSolutions().add(shadowingConflictSolutionType);
        shadowingConflictSolutionType = new ShadowingConflictSolutionType();
        shadowingConflictSolutionType.setAnomalyId(BigInteger.valueOf(21));
        shadowingConflictSolutionType.setToRemove(false);
        shadowingConflictSolutionType.setToChangeOrder(true);
        solveRequest.getShadowingConflictSolutions().add(shadowingConflictSolutionType);
        shadowingConflictSolutionType = new ShadowingConflictSolutionType();
        shadowingConflictSolutionType.setAnomalyId(BigInteger.valueOf(22));
        shadowingConflictSolutionType.setToRemove(false);
        shadowingConflictSolutionType.setToChangeOrder(true);
        solveRequest.getShadowingConflictSolutions().add(shadowingConflictSolutionType);
        shadowingConflictSolutionType = new ShadowingConflictSolutionType();
        shadowingConflictSolutionType.setAnomalyId(BigInteger.valueOf(24));
        shadowingConflictSolutionType.setToRemove(false);
        shadowingConflictSolutionType.setToChangeOrder(true);
        solveRequest.getShadowingConflictSolutions().add(shadowingConflictSolutionType);
        shadowingConflictSolutionType = new ShadowingConflictSolutionType();
        shadowingConflictSolutionType.setAnomalyId(BigInteger.valueOf(27));
        shadowingConflictSolutionType.setToRemove(false);
        shadowingConflictSolutionType.setToChangeOrder(true);
        solveRequest.getShadowingConflictSolutions().add(shadowingConflictSolutionType);
        shadowingConflictSolutionType = new ShadowingConflictSolutionType();
        shadowingConflictSolutionType.setAnomalyId(BigInteger.valueOf(29));
        shadowingConflictSolutionType.setToRemove(false);
        shadowingConflictSolutionType.setToChangeOrder(true);
        solveRequest.getShadowingConflictSolutions().add(shadowingConflictSolutionType);
        CorrelationSolutionType correlationSolutionType = new CorrelationSolutionType();
        correlationSolutionType.setAnomalyId(BigInteger.valueOf(6));
        ...
        correlationSolutionType.setAnomalyId(BigInteger.valueOf(7));
        correlationSolutionType.setToChange(false);
        solveRequest.getCorrelationSolutions().add(correlationSolutionType);
        correlationSolutionType = new CorrelationSolutionType();
        correlationSolutionType.setAnomalyId(BigInteger.valueOf(8));
        correlationSolutionType.setToChange(false);
        solveRequest.getCorrelationSolutions().add(correlationSolutionType);
        correlationSolutionType = new CorrelationSolutionType();
        correlationSolutionType.setAnomalyId(BigInteger.valueOf(9));
        correlationSolutionType.setToChange(false);
        solveRequest.getCorrelationSolutions().add(correlationSolutionType);
        return solveRequest;
    }
